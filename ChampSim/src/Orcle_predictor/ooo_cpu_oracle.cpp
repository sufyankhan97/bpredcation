...
/************ prajoytg :: Branch Information *****************************/           
        // The base is that if SP is involved, it'll be a branch
        ...
        //prajyotg :: This adds to total branches variable
...
/**********prajyotg :: Has operations with BP *******************************************/
uint32_t O3_CPU::add_to_ifetch_buffer(ooo_model_instr *arch_instr)
{
  ...
  */
  ...
  //prajyotg :: skip if its the first instruction in the trace
