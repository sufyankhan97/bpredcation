 ...
 * File         : dop.cc
 * Description  : Digital Options Pricing
 * ********************************************************/
...
int main(int argc, char **argv) {
  ...
  // prajyotg :: REDUCING int num_sims = 10000000;   // Number of simulated asset paths                                                       
  int num_sims = 100;   // Number of simulated asset paths                                                       
